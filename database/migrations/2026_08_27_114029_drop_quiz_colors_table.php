...
/**
 * De losse-kleuren-admin (QuizColorResource) is vervangen door de sfeerpaletten-admin
 * (QuizPalettesPage/quiz_palettes) — quiz_colors werd al sinds de invoering van de sfeerpaletten
 * niet meer door de klant-quiz gebruikt.
 */
