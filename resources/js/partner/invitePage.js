...
function initInvitePage(root) {
  ...
  function renderLandingCard(preview) {
    ...
    const intro = document.createElement("p");
    intro.className = "section-intro";
    intro.textContent = "Doe de test onafhankelijk van je partner, want jullie antwoorden blijven voor elkaar verborgen. Aan het eind krijg je, net als je partner, je eigen persoonlijke woonstijl, plus een gezamenlijk advies over hoe je jullie stijlen mooi kunt combineren in huis.";
